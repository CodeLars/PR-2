...
public class Tiergenerator {	
	...
	/*
	private static String [] raubvogel = {"Raub", "Raub", "Raub"};
	private static String[] vogel = {"sheep", "sheep", "sheep", "sheep", "sheep", "sheep"};
	
	private static String[] raubSaeuger = { "Raub", "Raub", "Raub", "Raub"};
	private static String[] saeuger = {"sheep", "sheep", "sheep", "sheep", "sheep"};
	
	private static String[] giftReptil = {"Gift", "Gift"};
	private static String[] raubReptil = {"Raub", "Raub"};
	private static String[] reptil = {"sheep", "sheep"};*/
